...
export class DisplayMapClass extends React.Component {
	...
	componentDidMount() {
		...
		var routingParameters = {
			...
			origin: String(this.props.originLat + "," + this.props.originLong),
			// The end point of the route:
			destination: String(this.props.destLat + "," + this.props.destLong),
	...
	render() {
		return <div className="map-div" ref={this.mapRef} />;
	}
}
